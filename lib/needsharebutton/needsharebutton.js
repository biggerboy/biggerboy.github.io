...
(function () {
  ...
  window.needShareButton = function (elem, options) {
    ...
    root.share = {
      ...
      "wechat": function (el) {
        var myoptions = getOptions(el);
        var imgSrc = "http://qr.api.cli.im/qr?level=H&transparent=0&bgcolor=%23ffffff&forecolor=&blockpixel=12&marginblock=2&logourl=http%3A%2F%2Falicliimg.clewm.net%2F606%2F417%2F5417606%2F15592060172660479988320040a11fd50abf399e918571559205905.jpg&size=400&text=&logoshape=no&fontsize=18&fontfamily=msyh.ttf&fontcolor=&incolor=&outcolor=&background=images%2Fbackground%2Fbg12.png&qrcode_eyes=pin-4.png&wper=0.74&hper=0.74&lper=0.13&tper=0.13&eye_use_fore=1&qrpad=10&kid=cliim&key=edf9a8d6582f7cc8fb777e4594177b3c&data=" + encodeURIComponent(myoptions.url);
